...
<template>
	<div class="courseSetting">
      ...
      <el-table-column prop="course_status" label="状态" align='center'></el-table-column>
    ...
    <el-dialog :visible.sync="visible22" center>
      ...
      <el-row>
        <el-col :span='18'>
          <el-table :data="cous" style="width:100%;margin-top:30px;margin-left:18%;" height="300" size="mini">
            <el-table-column type="index" label="序号" align='center'></el-table-column>
            <el-table-column prop="course_type_id" label="id" v-if='false' align='center'></el-table-column>
            <el-table-column prop="course_type_name" label="类型名称" align='center'></el-table-column>
            <el-table-column label="操作" align='center'>
              <template slot-scope='scope'>
                <i class="options fa fa-edit edit" @click="edit22(scope.$index,scope.row)"></i>
                <i class="options fa fa-trash delete" @click="delete22(scope.$index,scope.row)"></i>
              </template>
            </el-table-column>
          </el-table>
        </el-col>
