...
--> 
    <div class="table4">
      <table class='tableErr' v-loading="loading" element-loading-text="拼命加载中" id='tableErr' cellspacing="0" cellpadding="0" :max-height='height'>
        <thead>
          <tr>
