...
<template>
    ...
    <!-- 列表数据 -->
    <el-table :data="student" style="width:100%" class='table' border stripe :header-row-style="rowClass" size='mini' align='center' :height='height'>
      ...
      <el-table-column prop="class_grade" label="班级" fixed align='center' width='140'></el-table-column>
      ...
      <el-table-column prop="stu_number" label="学号" fixed align='center' width='140'></el-table-column>
...
export default {
  ...
  //分页：
    ...
    ...mapActions(['findAllStu','saveStu','deleteByIdStu','findStu','gradeAndClass','findClassStudent','downLoadStuTable','findRateNameStu']),
  },
}
</script>
